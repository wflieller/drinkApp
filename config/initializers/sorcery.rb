...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.twitter.key = "amldLqTuj1otkhM6rOyQUfiyk"
  config.twitter.secret = "WR4MLAuKxX0m4eevKbJRe3gK4fiD4FcuOGVDEpfEGXW4eucRh8"
  config.twitter.callback_url = "http://0.0.0.0:3000/oauth/callback?provider=twitter"
  config.twitter.user_info_mapping = {:username => "screen_name"}

  config.facebook.key = "648094511992667"
  config.facebook.secret = "d28c7fe1f1fac56f1c17af3e1f239c92"
